...
public class PermissionUtils {
    public static final int REQ_WRITE_STORAGE = 100;
    public static final int REQ_LOCATION = 101;

    /**
     * @param activity
     * @param requestCode same startActivityForResult(Intent, requestCode)
     * @param permissions ex: Manifest.permission.WRITE_EXTERNAL_STORAGE
     * @return <b>true</b> if permission has granted <b>false</b> for otherwise
     */
